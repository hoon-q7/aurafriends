...
// (레벨, IDIOMS, COMPAT_TABLE, 사주 엔진 함수, Supabase 한자, 성명학, 유틸, ScoreRing, AnimBar, ElementRadar, PackReveal, HanjaPicker, LuckyItems, HomeScreen, FortuneScreen, AddScreen, FriendsScreen, MatchScreen, AuraFriends까지 **원본 그대로** 유지하면서 오염된 따옴표/대시만 교정)
