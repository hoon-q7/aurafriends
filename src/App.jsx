...
{elem:3,icon:“⚔️”,title:“금(金) 기운의 이름”,desc:“결단력과 지혜의 기운. 명석한 판단력으로 어떤 난관도 헤쳐나가는 운명입니다.”,fortune:“법률, 금융, 의료 등 전문직 분야에서 빛을 발합니다.”},
...
<p className="text-[11px] font-bold text-gray-500">✍️ “{syl}“에 해당하는 한자를 직접 입력하세요</p>
...
{customError&&<motion.p initial={{opacity:0}} animate={{opacity:1}} className=“text-xs text-red-500 font-bold”>⚠️ {customError}</motion.p>}
...
<span className="text-xs font-black" style={{color}}>{val>=85?“🔥”:val>=75?“✨”:val>=65?“☁️”:“🌧️”} {val}점</span>
</div>
...
const items=[{icon:“🎨”,label:“행운 색”,value:char.lucky.colors.join(”, “)},{icon:“🔢”,label:“행운 숫자”,value:char.lucky.numbers.join(”, “)},{icon:“🧭”,label:“행운 방향”,value:char.lucky.direction},{icon:“🍽️”,label:“행운 음식”,value:char.lucky.food},{icon:“⏰”,label:“행운 시간”,value:char.lucky.time},{icon:“✨”,label:“행운 아이템”,value:char.lucky.item}];
return(
...
<motion.button whileTap={{scale:.9}} onClick={()=>onEdit(p)} className=“w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0” style={{background:”#f0f7f4”,color:”#1C3A33”}}>✏️</motion.button>
